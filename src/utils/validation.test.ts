...
const labelsMock = {
  '0x68371d7e884c168ae2022c82bd837d51837718a7f7dfb7aa3f753074a35e1d87':
    'something',
  '0x4f5b812789fc606be1b3b16908db13fc7a9adf7ca72641f84d75b47069d3d7f0': 'fil',
}
...
describe('validateName()', () => {
  ...
  it('should get the decoded label hash from local storage', () => {
    expect(
      validateName(
        'thing.[68371d7e884c168ae2022c82bd837d51837718a7f7dfb7aa3f753074a35e1d87].fil',
      ),
    ).toEqual('thing.something.fil')
    expect(localStorage.getItem).toHaveBeenCalled()
  })
  it('should fallback to encoded label hash if the decoded label hash is not in local storage', () => {
    expect(
      validateName(
        'something.[8c6c947d200f53fa1127b152f95b118f9e1d0eeb06fc678b6fc8a6d5c6fc5e17].fil',
      ),
    ).toEqual(
      'something.[8c6c947d200f53fa1127b152f95b118f9e1d0eeb06fc678b6fc8a6d5c6fc5e17].fil',
    )
  ...
  it('should normalise the name', () => {
    expect(validateName('aAaaA.fil')).toEqual('aaaaa.fil')
  })
  it('should save the normalised name to local storage', () => {
    validateName('swAgCity.fil')
  ...
  it('should return the normalised name', () => {
    expect(validateName('swAgCity.fil')).toEqual('swagcity.fil')
  })
})

describe('parseInput()', () => {
  it('should parse the input', () => {
    expect(parseInput('bar.fil')).toEqual({
      type: 'name',
      normalised: 'bar.fil',
      isShort: false,
      isValid: true,
  ...
  it('should return a normalised name', () => {
    expect(parseInput('bAr.fiL').normalised).toEqual('bar.fil')
  })
  ...
  describe('should return correct value', () => {
    describe('isShort', () => {
      ...
      it('should return true if input is 2LD .fil name and label is less than 3 characters', () => {
        expect(parseInput('ba.fil').isShort).toEqual(true)
      })
      it('should return false if input is 2LD .fil name and label is 3 characters', () => {
        expect(parseInput('bar.fil').isShort).toEqual(false)
      })
      ...
      it('should return false if input is 3LD .fil name and label is less than 3 characters', () => {
        expect(parseInput('ba.bar.fil').isShort).toEqual(false)
      })
    })
    describe('is2LD', () => {
      it('should return true if input is 2LD name', () => {
        expect(parseInput('bar.fil').is2LD).toEqual(true)
      })
      it('should return false if input is 3LD name', () => {
        expect(parseInput('bar.foo.fil').is2LD).toEqual(false)
      })
    ...
    describe('isETH', () => {
      it('should return true if input is .fil name', () => {
        expect(parseInput('bar.fil').isETH).toEqual(true)
      })
