...
import { FNS } from '..'
import type { RegistrarController, PublicResolver } from '../generated'
import {
  makeCommitment,
  makeCommitmentData,
...
beforeAll(async () => {
  ...
  controller = await fnsInstance.contracts!.getRegistrarController()!
  baseData = {
    name: 'test.fil',
    owner: accounts[1],
    duration: 31536000,
...
describe('registerHelpers', () => {
  ...
  describe('makeCommitmentData', () => {
    it('should add FIL record if reverseRecord is true and no records', () => {
